		...
		<table border="1">
		  ...
		  <c:forEach var="book" items="${books}">
		    <tr>
		      ...
		      <td>
		        <div>
			        <a href="${pageContext.request.contextPath}/update?action=rent&id=${book.id}"class="button">
		               RENT
		            </a>
	              	<a href="${pageContext.request.contextPath}/update?action=return&id=${book.id}"class="button">
	              	  RETURN
	              	</a>
	              	<a href="${pageContext.request.contextPath}/edit?id=${book.id}"class="button">
	              	  EDIT
	              	</a>
              	</div>
		      </td>
